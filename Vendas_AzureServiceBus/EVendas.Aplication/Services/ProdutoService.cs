...
namespace EVendas.Aplication.Services
{
    public class ProdutoService : IProdutoService
    {
        ...
        public ProdutoModel GetCodigoAsync(string codigoProduto)
        {
       
            return _mapper.Map<ProdutoModel>(_produtoRepository.GetAll().Where(x => x.CodigoProduto.ToUpper() == codigoProduto.ToUpper()).FirstOrDefault());
        }
